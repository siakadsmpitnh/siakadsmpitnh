 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header" style="text-align: center;">MENU ADMINISTRATOR</li>
        <li class="<?= ($this->uri->segment(1)=='' || $this->uri->segment(2)=='Dashboard') ? 'active':'' ?>">
         ...
         <li class="<?= ($this->uri->segment(1)=='Admin' && $this->uri->segment(2)=='Akademik') ? 'active':'' ?>">
          <a href="<?php echo base_url(); ?>Admin/Akademik">
            <i class="fa fa-calendar"></i> <span>Akademik</span></a></li>
          </a>
        </li>
         ...
         <li class="treeview <?= ($this->uri->segment(2)=='Guru' || $this->uri->segment(2)=='Wali')  ? 'active':'' ?>">
          <a href="">
            <i class="fa fa-table"></i> <span>Daftar Guru</span>
          ...
          <a href="<?php echo base_url(); ?>Admin/Guru">
            <i class="fa fa-circle-o"></i>Guru</a></li>
          </a>
        </li>
            <li class="<?= ($this->uri->segment(1)=='Admin' && $this->uri->segment(2)=='Wali') ? 'active':'' ?>"><a href="<?php echo base_url(); ?>Admin/Wali"><i class="fa fa-circle-o"></i>Wali</a></li>
          </ul>
        </li>
        ...
        <li class="treeview <?= ($this->uri->segment(2)=='Kelas' || $this->uri->segment(2)=='Kelas_Siswa' || $this->uri->segment(2)=='Kelas_Guru' || $this->uri->segment(2)=='Pindah' )  ? 'active':'' ?>">
         ...
         <li class="<?= ($this->uri->segment(1)=='Admin' && $this->uri->segment(2)=='Admin') ? 'active':'' ?>">
