   ...
   <div class="col-md-12">
         ...
         <div class="box box-success box-solid">
            <div class="box-header with-border">
               <h3 class="box-title"><i class="fa fa-building-o">&nbsp;</i> Tambah Kelas Guru</h3>

            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Admin/Kelas_Guru/add">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Pilih Pelajaran</label>
                  <div class="col-sm-10">
                   <select class="form-control select2" name="pelajaran" style="width: 100%;">
                      <?php foreach($mapel as $data){?>
                              <option value="<?php echo $data->Nama_Mapel ?>"><?php echo $data->Nama_Mapel ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Pilih Guru</label>
                  <div class="col-sm-10">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a onclick='hapus("<?= $data->Id_Kelas_Guru?>")' class="btn btn-danger" href="#"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                <?php } ?>
              </table>
        ...
        function hapus(id=null) {
            if(id!=null) {
                swal({
                  ...
                  if (result.value) {
                    window.location.href = "<?php echo base_url(); ?>Admin/Kelas_Guru/hapus/" + id;
                  }
                });
            }
        }
