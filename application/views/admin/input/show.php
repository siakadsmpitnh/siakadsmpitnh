         ...
         <div class="box box-success box-solid">
            ...
            <table id="example1" class="table table-bordered table-striped responsive">
                ...
                <tr>
                  ...
                  <td> <a class="btn btn-info" href="<?php echo base_url(); ?>Admin/Input/edit/<?php echo $data->Id_Nilai ?>"><i class="fa fa-edit"></i></a>
        ...
        function hapus(id=null) {
            if(id!=null) {
                swal({
                  ...
                  if (result.value) {
                    window.location.href = "<?php echo base_url(); ?>Admin/Input/hapus/" + id;
                  }
                });
            }
        }
