   ...
   <div class="col-md-12">
         ...
         <div class="box box-success box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Wali</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Admin/Wali/update">
              <div class="box-body">
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kelas</label>
                  <div class="col-sm-10">
                    <input type="text" name="kelas" class="form-control" value="<?php echo $guru->Nama_Kelas ?>" id="inputEmail3" placeholder="Nama Guru" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_guru" class="form-control" value="<?php echo $guru->Nama_Guru ?>" id="inputEmail3" placeholder="Nama Guru" readonly>
                    <input type="hidden" name="id_guru" class="form-control" value="<?php echo $guru->Id_Guru ?>" id="inputEmail3">
                  </div>
                </div>
                <div class="form-group">
